        ...
        <div className="LoginPage-background">
            <div className="Login-card">
                <form onSubmit={handleLogin}>
                    ...
                    <button className="libtn home-btn" type="button" onClick={() => navigate("/")}><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-left-circle" viewBox="0 0 16 16">
